...
public function validatePassword($attribute, $params)
{
    if (!$this->hasErrors()) {
        ...
        try {
            ...
            Yii::error("Invalid password hash for user ID {$user->id}: ".$e->getMessage(), __METHOD__);
            $this->addError($attribute, 'Your account password is invalid. Please reset your password.');
        }
    }
}
