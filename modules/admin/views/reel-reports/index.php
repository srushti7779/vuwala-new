...
/* @var $searchModel app\modules\admin\models\search\ReelReportsSearch */
...
$this->title = Yii::t('app', 'Reel Reports');
...
<div class="card">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Reel Reports'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid-reel-reports-search-user_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Reels', 'id' => 'grid-reel-reports-search-reel_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-reel-reports']],
        'panel' => [
