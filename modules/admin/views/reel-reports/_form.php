...
<div class="reel-reports-form">
 ...
 <div class='col-lg-6'>    <?= $form->field($model, 'reel_id')->widget(\kartik\widgets\Select2::classname(), [
 ...
 <div class='col-lg-6'>    <?= $form->field($model, 'feedback')->textarea(['rows' => 6])  ?> </div>

 <div class='col-lg-6'>    <?= $form->field($model, 'reported_at')->widget(\kartik\datecontrol\DateControl::classname(), [
        'type' => \kartik\datecontrol\DateControl::FORMAT_DATETIME,
        'saveFormat' => 'php:Y-m-d H:i:s',
        'ajaxConversion' => true,
        'options' => [
            'pluginOptions' => [
                'placeholder' => Yii::t('app', 'Choose Reported At'),
                'autoclose' => true,
            ]
        ],
    ]);  ?> </div>
