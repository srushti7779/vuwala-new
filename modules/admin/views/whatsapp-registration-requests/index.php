...
/* @var $searchModel app\modules\admin\models\search\WhatsappRegistrationRequestsSearch */
...
$this->title = Yii::t('app', 'Whatsapp Registration Requests');
...
?>
<div class="whatsapp-registration-requests-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Whatsapp Registration Requests'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-whatsapp-registration-requests']],
        'panel' => [
