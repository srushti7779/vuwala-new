...
/* @var $searchModel app\modules\admin\models\search\AisensyTemplateSentLogSearch */
...
$this->title = Yii::t('app', 'Aisensy Template Sent Logs');
...
?>
<div class="aisensy-template-sent-log-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Aisensy Template Sent Log'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-aisensy-template-sent-log']],
        'panel' => [
