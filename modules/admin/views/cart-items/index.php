...
/* @var $searchModel app\modules\admin\models\search\CartItemsSearch */
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Cart', 'id' => 'grid-cart-items-search-cart_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid-cart-items-search-user_id']
            ],
   
        [
                'attribute' => 'service_item_id',
                'label' => Yii::t('app', 'Service Item'),
                'value' => function($model){                   
                    return $model->serviceItem->id;                   
                },
                'filterType' => GridView::FILTER_SELECT2,
                ...
                'filterInputOptions' => ['placeholder' => 'Services', 'id' => 'grid-cart-items-search-service_item_id']
            ],
