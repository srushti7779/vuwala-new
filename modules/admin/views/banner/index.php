...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Main category', 'id' => 'grid-banner-search-main_category_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Vendor details', 'id' => 'grid-banner-search-vendor_details_id']
            ],
        ...
        [
            ...
            'format' => 'raw',
            'value'=> function ($model){
                return  html::img($model->image,['width'=>'100','height'=>'auto']);
            }
        ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-banner']],
        'panel' => [
