...
/* @var $searchModel app\modules\admin\models\search\VendorMainCategoryDataSearch */
...
$this->title = Yii::t('app', 'Vendor Main Category Datas');
...
?>
<div class="vendor-main-category-data-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Vendor Main Category Data'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid-vendor-main-category-data-search-user_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Vendor details', 'id' => 'grid-vendor-main-category-data-search-vendor_details_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Main category', 'id' => 'grid-vendor-main-category-data-search-main_category_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-vendor-main-category-data']],
        'panel' => [
