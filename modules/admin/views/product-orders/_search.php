...
/* @var $model app\modules\admin\models\search\ProductOrdersSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="form-product-orders-search">
    ...
    <?= $form->field($model, 'tax_percentage')->textInput(['placeholder' => 'Tax Percentage']) ?>
