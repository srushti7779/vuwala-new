...
/* @var $searchModel app\modules\admin\models\search\UOMHierarchySearch */
...
$this->title = Yii::t('app', 'Uom Hierarchies');
...
<div class="card">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Uom Hierarchy'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Sku', 'id' => 'grid-uomhierarchy-search-sku_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Units', 'id' => 'grid-uomhierarchy-search-units_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Units', 'id' => 'grid-uomhierarchy-search-of_units_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-uomhierarchy']],
        'panel' => [
