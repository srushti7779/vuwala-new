...
?>
<div class="vendor-expenses-view">
<div class="card">
       <div class="card-body">
    <div class="row">
        <div class="col-sm-9">
            <h2><?= Yii::t('app', 'Vendor Expenses').' '. Html::encode($this->title) ?></h2>
        </div>
...
?>
    ...
    <div class="card">
       <div class="card-body">
    <div class="row">
        <h4>VendorExpensesTypes<?= ' '. Html::encode($this->title) ?></h4>
    </div>
    <?php 
    $gridColumnVendorExpensesTypes = [
        ['attribute' => 'id', 'visible' => false],
        [
            'attribute' => 'vendorDetails.id',
            'label' => Yii::t('app', 'Vendor Details'),
    ...
    echo DetailView::widget([
        ...
        'attributes' => $gridColumnVendorExpensesTypes    ]);
    ?>
    </div>
    </div>
    <div class="card">
