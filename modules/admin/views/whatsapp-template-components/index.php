...
/* @var $searchModel app\modules\admin\models\search\WhatsappTemplateComponentsSearch */
...
$this->title = Yii::t('app', 'Whatsapp Template Components');
...
?>
<div class="whatsapp-template-components-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Whatsapp Template Components'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filter' => \yii\helpers\ArrayHelper::map(\app\modules\admin\models\WhatsappTemplates::find()->asArray()->all(), 'id', 'name'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
                'filterInputOptions' => ['placeholder' => 'Whatsapp templates', 'id' => 'grid-whatsapp-template-components-search-template_id']
            ],
