...
/* @var $searchModel app\modules\admin\models\search\ProductServicesSearch */
...
?>
<div class="product-services-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Product Services'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Services', 'id' => 'grid-product-services-search-service_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Products', 'id' => 'grid-product-services-search-product_id']
            ],
