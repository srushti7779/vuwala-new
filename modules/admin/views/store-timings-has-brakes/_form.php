...
<div class="store-timings-has-brakes-form">
 ...
 <div class='col-lg-6'>    <?= $form->field($model, 'store_timing_id')->widget(\kartik\widgets\Select2::classname(), [
 ...
 <div class='col-lg-6'>    <?= $form->field($model, 'start_time')->textInput(['maxlength' => true, 'placeholder' => 'Start Time'])  ?> </div>

 <div class='col-lg-6'>    <?= $form->field($model, 'end_time')->textInput(['maxlength' => true, 'placeholder' => 'End Time'])  ?> </div>
