...
/* @var $searchModel app\modules\admin\models\search\ShopReviewSearch */
...
$this->title = Yii::t('app', 'Shop Reviews');
...
<div class="card">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Shop Review'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Vendor details', 'id' => 'grid-shop-review-search-vendor_details_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid-shop-review-search-user_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Orders', 'id' => 'grid-shop-review-search-order_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-shop-review']],
        'panel' => [
