...
/* @var $model app\modules\admin\models\search\ShopReviewSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="form-shop-review-search">
    ...
    <?php /* echo $form->field($model, 'rating')->textInput(['maxlength' => true, 'placeholder' => 'Rating']) */ ?>
