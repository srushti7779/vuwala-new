...
/* @var $searchModel app\modules\admin\models\search\StoresHasUsersSearch */
...
$this->title = Yii::t('app', 'Stores Has Users');
...
?>
<div class="stores-has-users-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Stores Has Users'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Vendor details', 'id' => 'grid-stores-has-users-search-vendor_details_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid-stores-has-users-search-guest_user_id']
            ],
        ...
        [
                ...
                'value' => function($model){                   
                    return $model->vendorUser->username;                   
                },
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\app\modules\admin\models\User::find()->asArray()->all(), 'id', 'username'),
                'filterWidgetOptions' => [
                ...
                'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid-stores-has-users-search-vendor_user_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-stores-has-users']],
        'panel' => [
