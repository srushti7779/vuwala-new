...
/* @var $model app\modules\admin\models\search\StoresHasUsersSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="form-stores-has-users-search">
    ...
    <?= $form->field($model, 'vendor_user_id')->widget(\kartik\widgets\Select2::classname(), [
        'data' => \yii\helpers\ArrayHelper::map(\app\modules\admin\models\User::find()->orderBy('id')->asArray()->all(), 'id', 'username'),
        'options' => ['placeholder' => Yii::t('app', 'Choose User')],
        'pluginOptions' => [
            'allowClear' => true
    ...
    <?= $form->field($model, 'is_vip')->checkbox() ?>
