...
\mootensai\components\JsBlock::widget(['viewFile' => '_script', 'pos'=> \yii\web\View::POS_END, 
    'viewParams' => [
        ...
        'relID' => 'vendor-expenses', 
        'value' => \yii\helpers\Json::encode($model->vendorExpenses),
        'isNewRecord' => ($model->isNewRecord) ? 1 : 0
    ]
]);
?>

<div class="vendor-expense-type-form">
    ...
    <?= $form->field($model, 'main_vendor_user_id')->widget(\kartik\widgets\Select2::classname(), [
    ...
    $forms = [
        [
            'label' => '<i class="glyphicon glyphicon-book"></i> ' . Html::encode(Yii::t('app', 'VendorExpenses')),
            'content' => $this->render('_formVendorExpenses', [
                'row' => \yii\helpers\ArrayHelper::toArray($model->vendorExpenses),
            ]),
        ],
    ];
