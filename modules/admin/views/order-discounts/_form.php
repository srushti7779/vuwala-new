...
<div class="order-discounts-form">
 ...
 <div class='col-lg-6'>    <?= $form->field($model, 'discount_amount')->textInput(['maxlength' => true, 'placeholder' => 'Discount Amount'])  ?> </div>

 <div class='col-lg-6'>    <?= $form->field($model, 'discount_type')->textInput(['maxlength' => true, 'placeholder' => 'Discount Type'])  ?> </div>

 <div class='col-lg-6'>    <?= $form->field($model, 'discount_code')->textInput(['maxlength' => true, 'placeholder' => 'Discount Code'])  ?> </div>
