...
<div class="banner-logs-form">
 ...
 <div class='col-lg-6'>    <?= $form->field($model, 'banner_id')->textInput(['placeholder' => 'Banner'])  ?> </div>

 <div class='col-lg-6'>    <?= $form->field($model, 'user_id')->textInput(['placeholder' => 'User'])  ?> </div>

 <div class='col-lg-6'>    <?= $form->field($model, 'action_type')->dropDownList([ 'view' => 'View', 'click' => 'Click', ], ['prompt' => ''])  ?> </div>

 <div class='col-lg-6'>    <?= $form->field($model, 'ip_address')->textInput(['maxlength' => true, 'placeholder' => 'Ip Address'])  ?> </div>

 <div class='col-lg-6'>    <?= $form->field($model, 'user_agent')->textarea(['rows' => 6])  ?> </div>
