...
/* @var $searchModel app\modules\admin\models\search\ComboOrderSearch */
...
$this->title = Yii::t('app', 'Combo Orders');
...
<div class="card">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Combo Order'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Orders', 'id' => 'grid-combo-order-search-order_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Vendor details', 'id' => 'grid-combo-order-search-vendor_details_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Combo packages', 'id' => 'grid-combo-order-search-combo_package_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-combo-order']],
        'panel' => [
