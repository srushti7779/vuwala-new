...
<div class="card">
    <div class="card-header">
          <h4><?= Yii::t('app', 'Reels tags Counts') . ' ' . Html::encode($this->title) ?></h4>
    </div>
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-12">
                ...
                $providerReeltagCounts = new ArrayDataProvider([
                    'allModels' => [$model], 
                    'pagination' => false,
                ]);

                echo GridView::widget([
                    'dataProvider' => $providerReeltagCounts,
                    'pjax' => true,
