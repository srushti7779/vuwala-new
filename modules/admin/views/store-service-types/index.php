...
/* @var $searchModel app\modules\admin\models\search\StoreServiceTypesSearch */
...
$this->title = Yii::t('app', 'Store Service Types');
...
?>
<div class="store-service-types-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Store Service Types'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Vendor details', 'id' => 'grid-store-service-types-search-store_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Service type', 'id' => 'grid-store-service-types-search-service_type_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Main category', 'id' => 'grid-store-service-types-search-main_category_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-store-service-types']],
        'panel' => [
