<div class="form-group" id="add-quiz-user-answers">
<?php
...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'is_correct' => ['type' => TabularForm::INPUT_CHECKBOX,
            'options' => [
                'style' => 'position : relative; margin-top : -9px'
            ]
        ],
        'answered_on' => ['type' => TabularForm::INPUT_WIDGET,
        ...
        'del' => [
            ...
            'value' => function($model, $key) {
                return
                    ...
                    Html::a('<i class="fa fa-trash"></i>', '#', ['title' =>  Yii::t('app', 'Delete'), 'onClick' => 'delRowQuizUserAnswers(' . $key . '); return false;', 'id' => 'quiz-user-answers-del-btn']);
            },
        ],
    ],
    'gridSettings' => [
        'panel' => [
            ...
            'before' => false,
            'footer' => false,
            'after' => Html::button('<i class="fa fa-plus"></i>' . Yii::t('app', 'Add Quiz User Answers'), ['type' => 'button', 'class' => 'btn btn-success kv-batch-create', 'onClick' => 'addRowQuizUserAnswers()']),
        ]
    ]
]);
echo  "    </div>\n\n";
