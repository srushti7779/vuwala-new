...
/* @var $searchModel app\modules\admin\models\search\QuizzesSearch */
...
<div class="card">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Quizzes'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    ...
    'urlCreator' => function ($action, $model, $key, $index) {
        return \yii\helpers\Url::to(['quizzes/' . $action, 'id' => $model->id]);
    },
    'buttons' => [
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-quizzes']],
        'panel' => [
