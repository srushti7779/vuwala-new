...
/* @var $model app\modules\admin\models\ProductCategories */
...
<div class="card">
    ...
    <div class="row">
        <div class="col-sm-9">
            <h2><?= Yii::t('app', 'Product Categories').' '. Html::encode($this->title) ?></h2>
        </div>
...
if($providerSku->totalCount){
    $gridColumnSku = [
        ['class' => 'yii\grid\SerialColumn'],
            ...
            'tax_rate',
            [
                'attribute' => 'baseUnit.id',
                'label' => Yii::t('app', 'Base Unit')
            ],
