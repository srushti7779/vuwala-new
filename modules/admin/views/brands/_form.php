...
<div class="brands-form">
 ...
 <div class='col-lg-6'>    <?= $form->field($model, 'brand_name')->textInput(['placeholder' => 'Brand Name'])  ?> </div>

 <div class='col-lg-6'>    <?= $form->field($model, 'image')->textInput(['maxlength' => true, 'placeholder' => 'Image'])  ?> </div>

 <div class='col-lg-6'>    <?= $form->field($model, 'is_global')->textInput(['placeholder' => 'Is Global'])  ?> </div>
