...
/* @var $searchModel app\modules\admin\models\search\AisensyWebhooksSearch */
...
$this->title = Yii::t('app', 'Aisensy Webhooks');
...
?>
<div class="aisensy-webhooks-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Aisensy Webhooks'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-aisensy-webhooks']],
        'panel' => [
