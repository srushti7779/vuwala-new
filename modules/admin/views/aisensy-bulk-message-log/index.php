...
/* @var $searchModel app\modules\admin\models\search\AisensyBulkMessageLogSearch */
...
$this->title = Yii::t('app', 'Aisensy Bulk Message Logs');
...
?>
<div class="aisensy-bulk-message-log-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Aisensy Bulk Message Log'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filter' => \yii\helpers\ArrayHelper::map(\app\modules\admin\models\AisensyBulkCampaignLog::find()->asArray()->all(), 'id', 'id'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
                'filterInputOptions' => ['placeholder' => 'Aisensy bulk campaign log', 'id' => 'grid-aisensy-bulk-message-log-search-campaign_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Aisensy templates', 'id' => 'grid-aisensy-bulk-message-log-search-template_id']
            ],
