...
/* @var $searchModel app\modules\admin\models\search\QuizQuestionsSearch */
...
$this->title = Yii::t('app', 'Quiz Questions');
...
<div class="card">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Quiz Questions'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Quizzes', 'id' => 'grid-quiz-questions-search-quiz_id']
            ],
