...
/* @var $searchModel app\modules\admin\models\search\ComboPackagesSearch */
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Vendor details', 'id' => 'grid-combo-packages-search-vendor_details_id']
            ],
        ...
        'time',
[
    'attribute' => 'services_ids', 
    'label' => 'Services',
    'value' => function ($model) {
        return implode(', ', \yii\helpers\ArrayHelper::getColumn($model->services, 'service_name'));
    },
    'filterType' => GridView::FILTER_SELECT2,
    'filter' => \yii\helpers\ArrayHelper::map(\app\modules\admin\models\Services::find()->all(), 'id', 'service_name'),
    'filterWidgetOptions' => [
        'pluginOptions' => ['allowClear' => true],
    ],
    'filterInputOptions' => ['placeholder' => 'Select Services...'],
],
// [
//     'attribute' => 'service_for',
//     'value' => function ($model) {
//         return $model->service_for;
//     },
// ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-combo-packages']],
        'panel' => [
