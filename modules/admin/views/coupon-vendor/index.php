...
/* @var $searchModel app\modules\admin\models\search\CouponVendorSearch */
...
$this->title = Yii::t('app', 'Coupon Vendors');
...
<div class="card">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Coupon Vendor'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Coupon', 'id' => 'grid-coupon-vendor-search-coupon_id']
            ],
            [
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-coupon-vendor']],
        'panel' => [
