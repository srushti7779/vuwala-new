...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'mobile_no' => ['type' => TabularForm::INPUT_TEXT],
        ...
        'del' => [
            ...
            'value' => function($model, $key) {
                return
                    ...
                    Html::a('<i class="fa fa-trash"></i>', '#', ['title' =>  Yii::t('app', 'Delete'), 'onClick' => 'delRowStaff(' . $key . '); return false;', 'id' => 'staff-del-btn']);
            },
        ],
    ],
    'gridSettings' => [
        'panel' => [
            ...
            'before' => false,
            'footer' => false,
            'after' => Html::button('<i class="fa fa-plus"></i>' . Yii::t('app', 'Add Staff'), ['type' => 'button', 'class' => 'btn btn-success kv-batch-create', 'onClick' => 'addRowStaff()']),
        ]
    ]
]);
echo  "    </div>\n\n";
