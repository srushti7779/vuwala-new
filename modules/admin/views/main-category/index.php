...
/* @var $searchModel app\modules\admin\models\search\MainCategorySearch */
...
<div class="main-category-index">
    <div class="card">
        ...
        <!-- <div style="text-align: right;">
            <?= Html::a(Yii::t('app', 'Go To Sub Category'), ['sub-category/index'], ['class' => 'btn btn-success']) ?>
        </div> -->   
    ...
    <div class="card">
        <div class="card-body">
            ...
            $gridColumn = [
                ...
                [
                    ...
                    'value' => function ($model) {
                        $imageUrl = $model->image; // The absolute URL stored in the database
            ...
            <?= GridView::widget([
                ...
                'columns' => $gridColumn,
                'pjax' => true,
                'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-main-category']],
                'panel' => [
