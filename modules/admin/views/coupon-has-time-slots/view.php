...
?>
<div class="coupon-has-time-slots-view">
<div class="card">
       <div class="card-body">
    <div class="row">
        <div class="col-sm-9">
            <h2><?= Yii::t('app', 'Coupon Has Time Slots').' '. Html::encode($this->title) ?></h2>
        </div>
...
?>
    ...
    <div class="card">
       <div class="card-body">
    <div class="row">
        <h4>CouponHasDays<?= ' '. Html::encode($this->title) ?></h4>
    </div>
    <?php 
    $gridColumnCouponHasDays = [
        ['attribute' => 'id', 'visible' => false],
        [
            'attribute' => 'coupon.name',
            'label' => Yii::t('app', 'Coupon'),
    ...
    echo DetailView::widget([
        'model' => $model->couponHasDay,
        'attributes' => $gridColumnCouponHasDays    ]);
    ?>
    </div>
    </div>
    <div class="card">
