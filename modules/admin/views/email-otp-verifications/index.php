...
/* @var $searchModel app\modules\admin\models\search\EmailOtpVerificationsSearch */
...
$this->title = Yii::t('app', 'Email Otp Verifications');
...
?>
<div class="email-otp-verifications-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Email Otp Verifications'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-email-otp-verifications']],
        'panel' => [
