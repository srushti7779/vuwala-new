...
<div class="email-otp-verifications-form">
 ...
 <div class='col-lg-6'>    <?= $form->field($model, 'otp')->textInput(['maxlength' => true, 'placeholder' => 'Otp'])  ?> </div>

 <div class='col-lg-6'>    <?= $form->field($model, 'is_verified')->checkbox()  ?> </div>
