...
/* @var $searchModel app\modules\admin\models\search\AisensyTemplateComponentsSearch */
...
$this->title = Yii::t('app', 'Aisensy Template Components');
...
?>
<div class="aisensy-template-components-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Aisensy Template Components'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Aisensy templates', 'id' => 'grid-aisensy-template-components-search-template_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-aisensy-template-components']],
        'panel' => [
