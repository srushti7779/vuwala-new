    ...
    <div class="card">
        <div class="card-body">
            ...
            [
                ...
                'filterInputOptions' => ['placeholder' => 'Username', 'id' => 'grid-orders-search-user_id']
            ],
            [
            ...
            [
              ...
              [
                ...
                'value' => function ($model) {
                    return $model->user ? $model->user->contact_no : null;
                },
            ],
                ...
                [
                    ...
                    'format' => 'raw',
                    'value' => function ($model) {
                        return $model->getPaymentTypeOptionBadges();
                    },
                ...
                [
                    ...
                    'format' => 'raw',
                    'value' => function ($model) {
                        return $model->getPaymentStatusOptionBadges();
                    },
                ...
                [
                    ...
                    'format' => 'raw',
                    'value' => function ($model) {
                        return $model->getServiceTypeOptionBadges();
                    },
                ...
                [
                    ...
                    'buttons' => [
                        'view' => function ($url, $model) {
                            if (\Yii::$app->user->identity->user_role == User::ROLE_ADMIN || \Yii::$app->user->identity->user_role == User::ROLE_SUB_ADMIN || \Yii::$app->user->identity->user_role == User::ROLE_MANAGER||\Yii::$app->user->identity->user_role == User::ROLE_VENDOR) {
