...
/* @var $searchModel app\modules\admin\models\search\BusinessDocumentsSearch */
...
$this->title = Yii::t('app', 'Business Documents');
...
?>
<div class="business-documents-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Business Documents'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Vendor details', 'id' => 'grid-business-documents-search-vendor_details_id']
            ],
