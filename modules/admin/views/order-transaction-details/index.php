...
/* @var $searchModel app\modules\admin\models\search\OrderTransactionDetailsSearch */
...
$this->title = Yii::t('app', 'Order Transaction Details');
...
?>
<div class="order-transaction-details-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Order Transaction Details'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-order-transaction-details']],
        'panel' => [
