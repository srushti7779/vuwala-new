...
/* @var $model app\modules\admin\models\search\NextVisitDetailsSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="form-next-visit-details-search">
    ...
    <?= $form->field($model, 'next_visit_details_json')->textarea(['rows' => 6]) ?>
    ...
    <?php /* echo $form->field($model, 'prescription_file')->textInput(['maxlength' => true, 'placeholder' => 'Prescription File']) */ ?>
