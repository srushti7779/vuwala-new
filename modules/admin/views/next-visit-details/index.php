...
/* @var $searchModel app\modules\admin\models\search\NextVisitDetailsSearch */
...
$this->title = Yii::t('app', 'Next Visit Details');
...
?>
<div class="next-visit-details-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Next Visit Details'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Orders', 'id' => 'grid-next-visit-details-search-order_id']
            ],
   
        'next_visit_details_json:ntext',
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-next-visit-details']],
        'panel' => [
