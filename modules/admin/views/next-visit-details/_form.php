...
<div class="next-visit-details-form">
 ...
 <div class='col-lg-6'>    <?= $form->field($model, 'next_visit_details_json')->textarea(['rows' => 6])  ?> </div>
 ...
 <div class='col-lg-6'>    <?= $form->field($model, 'prescription_file')->textInput(['maxlength' => true, 'placeholder' => 'Prescription File'])  ?> </div>
