...
/* @var $searchModel app\modules\admin\models\search\WhatsappApiLogsSearch */
...
$this->title = Yii::t('app', 'Whatsapp Api Logs');
...
?>
<div class="whatsapp-api-logs-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Whatsapp Api Logs'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-whatsapp-api-logs']],
        'panel' => [
