...
/* @var $searchModel app\modules\admin\models\search\OrderDetailsSearch */
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Orders', 'id' => 'grid-order-details-search-order_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Services', 'id' => 'grid-order-details-search-service_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-order-details']],
        'panel' => [
