...
/* @var $searchModel app\modules\admin\models\search\RescheduleOrderLogsSearch */
...
$this->title = Yii::t('app', 'Reschedule Order Logs');
...
?>
<div class="reschedule-order-logs-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Reschedule Order Logs'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Orders', 'id' => 'grid-reschedule-order-logs-search-order_id']
            ],
   
        [
                'attribute' => 'reschedule_by_user_id',
                'label' => Yii::t('app', 'Reschedule By User'),
                'value' => function($model){                   
                    return $model->rescheduleByUser->username;                   
                },
                'filterType' => GridView::FILTER_SELECT2,
                ...
                'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid-reschedule-order-logs-search-reschedule_by_user_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-reschedule-order-logs']],
        'panel' => [
