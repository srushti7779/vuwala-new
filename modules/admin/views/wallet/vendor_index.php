...
<div class="card">
  ...
  <p>
    ...
    <?php elseif (Yii::$app->user->identity->user_role == User::ROLE_VENDOR): ?>
        <?= Html::a(Yii::t('app', 'Create Wallet'), ['create-vendor'], ['class' => 'btn btn-success']) ?>
    <?php endif; ?>
...
<?php 
    $gridColumn = [
        ...
        //             'pluginOptions' => ['allowClear' => true],
        //         ],
        //         'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid-wallet-search-created_user_id']
        //     ],
        ...
        //             'pluginOptions' => ['allowClear' => true],
        //         ],
        //         'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid-wallet-search-updated_user_id']
        //     ],
        [
