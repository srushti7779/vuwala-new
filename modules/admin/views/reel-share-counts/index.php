...
/* @var $searchModel app\modules\admin\models\search\ReelShareCountsSearch */
...
$this->title = Yii::t('app', 'Reel Share Counts');
...
?>
<div class="reel-share-counts-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Reel Share Counts'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Reels', 'id' => 'grid-reel-share-counts-search-real_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid-reel-share-counts-search-user_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-reel-share-counts']],
        'panel' => [
