...
/* @var $searchModel app\modules\admin\models\search\SupportTicketsSearch */
...
<div class="card">
    ...
    <p>
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_VENDOR){ ?>
        <?= Html::a(Yii::t('app', 'Create Support Tickets'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        //         ],
        //         'filterInputOptions' => ['placeholder' => 'Vendor details', 'id' => 'grid-support-tickets-search-vendor_details_id']
        //     ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-support-tickets']],
        'panel' => [
