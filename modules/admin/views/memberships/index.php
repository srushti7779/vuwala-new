...
<div class="memberships-index">
    ...
    <p>
        <?= Html::a(Yii::t('app', 'Create MemberShips'), ['create'], ['class' => 'btn btn-success']) ?>
    ...
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Vendor details', 'id' => 'grid-memberships-search-vendor_details_id']
            ],
        'membership_name',
        'color',
        'discount',
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid-memberships-search-created_user_id']
            ],
        [
                ...
                'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid-memberships-search-updated_user_id']
            ],
        [
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-memberships']],
        'panel' => [
