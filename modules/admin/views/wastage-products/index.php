...
/* @var $searchModel app\modules\admin\models\search\WastageProductsSearch */
...
$this->title = Yii::t('app', 'Wastage Products');
...
?>
<div class="wastage-products-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Wastage Products'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Vendor details', 'id' => 'grid-wastage-products-search-vendor_details_id']
            ],
        ...
        [
                ...
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\app\modules\admin\models\Products::find()->asArray()->all(), 'id', 'id'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
                'filterInputOptions' => ['placeholder' => 'Products', 'id' => 'grid-wastage-products-search-product_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Units', 'id' => 'grid-wastage-products-search-uom_id']
            ],
        ...
        [
                'attribute' => 'wastage_type',
                'label' => Yii::t('app', 'Wastage Type'),
                'value' => function($model){
                    if ($model->wastageType)
                    {return $model->wastageType->id;}
                    else
                    {return NULL;}
                },
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\app\modules\admin\models\WasteTypes::find()->asArray()->all(), 'id', 'id'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
                'filterInputOptions' => ['placeholder' => 'Waste types', 'id' => 'grid-wastage-products-search-wastage_type']
            ],
