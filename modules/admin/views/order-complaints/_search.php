...
/* @var $model app\modules\admin\models\search\OrderComplaintsSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="form-order-complaints-search">
    ...
    <?php /* echo $form->field($model, 'response')->textarea(['rows' => 6]) */ ?>
