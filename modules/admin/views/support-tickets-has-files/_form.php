...
<div class="support-tickets-has-files-form">
 ...
 <div class='col-lg-6'>    <?= $form->field($model, 'support_ticket_id')->widget(\kartik\widgets\Select2::classname(), [
 ...
 <div class='col-lg-6'>    <?= $form->field($model, 'file')->textInput(['maxlength' => true, 'placeholder' => 'File'])  ?> </div>
