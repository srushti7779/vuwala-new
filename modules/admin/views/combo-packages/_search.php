...
/* @var $model app\modules\admin\models\search\ComboPackagesSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="form-combo-packages-search">
    ...
    <?php /* echo $form->field($model, 'is_home_visit')->checkbox() */ ?>

    <?php /* echo $form->field($model, 'is_walk_in')->checkbox() */ ?>

    <?php /* echo $form->field($model, 'service_for')->textInput(['placeholder' => 'Service For']) */ ?>
