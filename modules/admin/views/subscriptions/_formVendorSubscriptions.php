<div class="form-group" id="add-vendor-subscriptions">
<?php
        ...
        'del' => [
            ...
            'value' => function($model, $key) {
                return
                    ...
                    Html::a('<i class="fa fa-trash"></i>', '#', ['title' =>  Yii::t('app', 'Delete'), 'onClick' => 'delRowVendorSubscriptions(' . $key . '); return false;', 'id' => 'vendor-subscriptions-del-btn']);
            },
        ],
    ],
    'gridSettings' => [
        'panel' => [
            ...
            'before' => false,
            'footer' => false,
            'after' => Html::button('<i class="fa fa-plus"></i>' . Yii::t('app', 'Add Vendor Subscriptions'), ['type' => 'button', 'class' => 'btn btn-success kv-batch-create', 'onClick' => 'addRowVendorSubscriptions()']),
        ]
    ]
]);
echo  "    </div>\n\n";
