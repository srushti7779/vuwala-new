...
/* @var $searchModel app\modules\admin\models\search\QuizAnswersSearch */
...
$this->title = Yii::t('app', 'Quiz Answers');
...
<div class="card">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Quiz Answers'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Quiz questions', 'id' => 'grid-quiz-answers-search-question_id']
            ],
