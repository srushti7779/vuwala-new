...
<div class="guest-user-deposits-form">
 ...
 <div class='col-lg-6'>    <?= $form->field($model, 'stores_has_user_id')->widget(\kartik\widgets\Select2::classname(), [
 ...
 <div class='col-lg-6'>    <?= $form->field($model, 'deposit_date_and_time')->widget(\kartik\datecontrol\DateControl::classname(), [
        'type' => \kartik\datecontrol\DateControl::FORMAT_DATETIME,
        'saveFormat' => 'php:Y-m-d H:i:s',
        'ajaxConversion' => true,
        'options' => [
            'pluginOptions' => [
                'placeholder' => Yii::t('app', 'Choose Deposit Date And Time'),
                'autoclose' => true,
            ]
        ],
    ]);  ?> </div>
