...
/* @var $model app\modules\admin\models\search\ReelsSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="form-reels-search">
    ...
    <?= $form->field($model, 'thumbnail')->textInput(['maxlength' => true, 'placeholder' => 'Thumbnail']) ?>
    ...
    <?php /* echo $form->field($model, 'view_count')->textInput(['placeholder' => 'View Count']) */ ?>

    <?php /* echo $form->field($model, 'share_count')->textInput(['placeholder' => 'Share Count']) */ ?>
