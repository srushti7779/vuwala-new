...
/* @var $searchModel app\modules\admin\models\search\OrderStatusSearch */
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Orders', 'id' => 'grid-order-status-search-order_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-order-status']],
        'panel' => [
