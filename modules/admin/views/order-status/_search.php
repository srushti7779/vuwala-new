...
/* @var $model app\modules\admin\models\search\OrderStatusSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="form-order-status-search">
    ...
    <?= $form->field($model, 'remarks')->textInput(['maxlength' => true, 'placeholder' => 'Remarks']) ?>
