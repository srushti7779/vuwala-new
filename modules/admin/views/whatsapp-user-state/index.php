...
/* @var $searchModel app\modules\admin\models\search\WhatsappUserStateSearch */
...
$this->title = Yii::t('app', 'Whatsapp User States');
...
?>
<div class="whatsapp-user-state-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Whatsapp User State'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-whatsapp-user-state']],
        'panel' => [
