...
/* @var $searchModel app\modules\admin\models\search\ServiceTypeSearch */
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Main category', 'id' => 'grid-service-type-search-main_category_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-service-type']],
        'panel' => [
