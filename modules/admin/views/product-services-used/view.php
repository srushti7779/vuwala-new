...
?>
<div class="product-services-used-view">
<div class="card">
       <div class="card-body">
    <div class="row">
        <div class="col-sm-9">
            <h2><?= Yii::t('app', 'Product Services Used').' '. Html::encode($this->title) ?></h2>
        </div>
...
?>
    ...
    <div class="card">
       <div class="card-body">
    <div class="row">
        <h4>ProductServices<?= ' '. Html::encode($this->title) ?></h4>
    </div>
    <?php 
    ...
    echo DetailView::widget([
        'model' => $model->productServices,
        'attributes' => $gridColumnProductServices    ]);
    ?>
    </div>
    </div>
    <div class="card">
