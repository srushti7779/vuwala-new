...
/* @var $searchModel app\modules\admin\models\search\ServicePinCodeSearch */
...
$this->title = Yii::t('app', 'Service Pin Codes');
...
?>
<div class="service-pin-code-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Service Pin Code'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'City', 'id' => 'grid-service-pin-code-search-city_id']
            ],
