...
/* @var $searchModel app\modules\admin\models\search\VendorBrandsSearch */
...
$this->title = Yii::t('app', 'Vendor Brands');
...
<div class="card">
    ...
    <p>
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN|| \Yii::$app->user->identity->user_role==User::ROLE_VENDOR){ ?>
        <?= Html::a(Yii::t('app', 'Create Vendor Brands'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid-vendor-brands-search-user_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-vendor-brands']],
        'panel' => [
