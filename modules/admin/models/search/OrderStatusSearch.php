...
/**
 * app\modules\admin\models\search\OrderStatusSearch represents the model behind the search form about `app\modules\admin\models\OrderStatus`.
 */
 class OrderStatusSearch extends OrderStatus
{
    ...
    public function rules()
    {
        return [
            ...
            [['remarks', 'created_on', 'updated_on'], 'safe'],
        ];
    } 
