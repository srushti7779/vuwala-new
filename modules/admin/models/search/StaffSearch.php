...
/**
 * app\modules\admin\models\search\StaffSearch represents the model behind the search form about `app\modules\admin\models\Staff`.
 */
 class StaffSearch extends Staff
{
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'profile_image', $this->profile_image])
