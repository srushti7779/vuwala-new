 ...
 * @property \app\modules\admin\models\ServicePinCode[] $servicePinCodes
...
class City extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return $this->hasMany(\app\modules\admin\models\ServicePinCode::className(), ['city_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\app\modules\admin\models\VendorDetails::className(), ['city_id' => 'id']);
    }
