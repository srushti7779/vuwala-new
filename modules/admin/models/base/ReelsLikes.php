...
/**
 * This is the base model class for table "reels_likes".
 *
 * @property integer $id
 ...
 */
class ReelsLikes extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \app\modules\admin\models\ReelsLikesQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\admin\models\ReelsLikesQuery(get_called_class());
    }
