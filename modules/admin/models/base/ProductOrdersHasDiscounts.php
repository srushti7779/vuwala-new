...
/**
 * This is the base model class for table "product_orders_has_discounts".
 *
 * @property integer $id
 ...
 */
class ProductOrdersHasDiscounts extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return 'product_orders_has_discounts';
    }
    ...
    /**
     * @inheritdoc
     * @return \app\modules\admin\models\ProductOrdersHasDiscountsQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\admin\models\ProductOrdersHasDiscountsQuery(get_called_class());
    }
