...
/**
 * This is the base model class for table "combo_services".
 *
 * @property integer $id
 ...
 */
class ComboServices extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['vendor_details_id', 'combo_package_id', 'services_id'], 'required'],
            [['vendor_details_id', 'combo_package_id', 'services_id', 'status', 'create_user_id', 'update_user_id'], 'integer'],
    ...
    {
        return $this->hasOne(\app\modules\admin\models\Services::className(), ['id' => 'services_id']);
    }
    ...
    /**
     * @inheritdoc
     * @return \app\modules\admin\models\ComboServicesQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\admin\models\ComboServicesQuery(get_called_class());
    }
    public function asJson()
    {
        ...
        $data['combo_package'] =  $this->comboPackage->asJsonVender();
    ...
    public function asJsonViewCart()
    {
        $data = [];
      
        $data['services_name'] =  $this->services->service_name ?? null;
        return $data;
    }
}
