...
/**
 * This is the base model class for table "order_discounts".
 *
 * @property integer $id
 ...
 */
class OrderDiscounts extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \app\modules\admin\models\OrderDiscountsQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\admin\models\OrderDiscountsQuery(get_called_class());
    }
