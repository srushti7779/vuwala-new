...
/**
 * This is the base model class for table "quiz_answers".
 *
 * @property integer $id
...
class QuizAnswers extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \app\modules\admin\models\QuizAnswersQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\admin\models\QuizAnswersQuery(get_called_class());
    }
