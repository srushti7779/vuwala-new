...
/**
 * This is the base model class for table "user_roles".
 *
 * @property integer $id
...
class UserRoles extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \app\modules\admin\models\UserRolesQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\admin\models\UserRolesQuery(get_called_class());
    }
}
