...
use app\modules\admin\models\search\VendorPayoutSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * VendorPayoutController implements the CRUD actions for VendorPayout model.
 */
class VendorPayoutController extends Controller
{
    ...
    /**
     * Lists all VendorPayout models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new VendorPayoutSearch();
    ...
    /**
     * Displays a single VendorPayout model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new VendorPayout model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new VendorPayout();
    ...
    /**
     * Updates an existing VendorPayout model.
    ...
    /**
     * Deletes an existing VendorPayout model.
    ...
    /**
     * Finds the VendorPayout model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return VendorPayout the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = VendorPayout::findOne($id)) !== null) {
            return $model;
        } else {
