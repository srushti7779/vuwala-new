...
use app\modules\admin\models\search\SkuSearch;
...
class SkuController extends Controller
{
        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['index', 'view', 'create', 'update', 'delete', 'update-status', 'add-products', 'add-uomhierarchy'],
    ...
    public function actionDelete($id)
    {
        ...
        $model = $this->findModel($id);
        if(!empty($model)){
            $model->status = Sku::STATUS_DELETE;
            $model->save(false); 
        }
